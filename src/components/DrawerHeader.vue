<script setup>
const emit = defineEmits(['onDrawerClose'])

</script>

<template>
    <h2 class="text-2xl font-bold mb-5 flex items-center gap-5" @click="() => emit('onDrawerClose')">
        <svg class="rotate-180 hover:-translate-x-1 opacity-30 hover:opacity-100 transition cursor-pointer" width="16"
